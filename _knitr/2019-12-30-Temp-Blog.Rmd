...
prettyjekyll::FormatPost("2019-12-30-Temp-Blog.Rmd")
```
...
The share of the regressor variable $x_i$ for a given set of $k$ predictor variables is given by the following formula: 
